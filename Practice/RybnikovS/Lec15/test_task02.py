...
class TestWithPytestSuite:
    ...
    def test_ge(self):
        assert ((Money(200, 30) >= Money(100, 60)) == True)

    def test_ge_rub_eq_t(self):
        assert ((Money(100, 90) >= Money(100, 60)) == True)

    def test_ge_rub_eq_f(self):
        assert ((Money(100, 10) >= Money(100, 60)) == False)
    ...
    def test_gt_rub_eq_f(self):
        assert ((Money(100, 30) > Money(100, 60)) == False)
